      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active">
            <a class="nav-link" href="available.html">Restaurant <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="orders.html">Bill </a>
          </li>          
        </ul>
      </div>
    </nav>	
    ...
    <div class="container home"  >
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="home-card">
                    <h2 class="card-title text-center"><span>311</span></h2>
                    <table class="table table-striped">
                      <tbody>
                        <tr>
                          <td colspan="2">Type Room</td>
                        </tr>
                        <tr>
                          <td colspan="2">Ahmed Ali seif</td>
                        </tr>
                        <tr>
                          <td>Total Cost</td>
                          <td>price room</td>
                        ...
                        <tr>
                          <td colspan="2"><a href="#" class="btn btn-info btn-block">Show More Details</a></td>
                        </tr>
                      </tbody>
                    </table>
                </div>            
